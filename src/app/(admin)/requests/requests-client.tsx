...
export function RequestsClient({
  ...
  return (
    <div className="flex flex-col gap-8 pb-12 relative">
      ...
      <div className={`grid gap-6 pt-1 ${activeTab === "all" ? "grid-cols-1 xl:grid-cols-2" : "grid-cols-1"}`}>
        ...
        {(activeTab === "all" || activeTab === "support") && (
          ...
          <CardHeader className="border-b-2 border-border/70 pt-4 sm:pt-5 pb-3.5 px-4 sm:px-5 bg-muted/30">
              ...
              <Table className="min-w-[560px]">
                <TableHeader className="bg-muted/40 border-b border-border/60">
                  <TableRow className="hover:bg-transparent">
                    <TableHead className="font-heading font-extrabold text-xs min-w-[130px] px-3 py-3">Học Viên</TableHead>
                    <TableHead className="font-heading font-extrabold text-xs px-3 py-3">Loại / Nội Dung</TableHead>
                    <TableHead className="w-[160px] min-w-[155px] font-heading font-extrabold text-xs px-2.5 py-3">Trạng Thái</TableHead>
                    <TableHead className="w-[110px] text-right font-heading font-extrabold text-xs px-3 py-3">Thao Tác</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {paginatedSupport.length === 0 ? (
                    ...
                    paginatedSupport.map((req) => (
                      ...
                      >
                        ...
                        {/* Type & Content */}
                        <TableCell className="space-y-1.5 px-3 py-2.5 whitespace-normal">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <Badge
                        ...
                        {/* Status Dropdown */}
                        <TableCell className="w-[160px] min-w-[155px] px-2.5 py-2.5">
                          <select
                            value={req.status}
                            disabled={processingId === req.id}
                            onChange={(e) => handleSupportStatusChange(req.id, e.target.value)}
                            className={`w-full min-w-[140px] h-8 text-[11px] font-black rounded-xl border-2 pl-2.5 pr-6 py-0.5 cursor-pointer shadow-2xs focus:outline-hidden transition-all ${
                              req.status === "NEW"
            ...
            <div className="overflow-x-auto">
              <Table className="min-w-[540px]">
                <TableHeader className="bg-muted/50 border-b-2 border-border/70">
                  <TableRow className="hover:bg-transparent">
                    <TableHead className="font-heading font-extrabold text-xs min-w-[130px] px-3 py-3">Học Viên</TableHead>
                    <TableHead className="font-heading font-extrabold text-xs px-3 py-3">Ca Nghỉ & Ca Bù</TableHead>
                    <TableHead className="w-[160px] min-w-[155px] font-heading font-extrabold text-xs px-2.5 py-3">Trạng Thái</TableHead>
                    <TableHead className="w-[110px] text-right font-heading font-extrabold text-xs px-3 py-3">Thao Tác</TableHead>
                  </TableRow>
                </TableHeader>
